...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function checkForMatch() {
       ...
       if (isMatch) {
          // The matching logic: if a match is found, play the corresponding sound
          const pairValue = cardOne.dataset.value;  // both cards have the same value
          if (pairSounds[pairValue]) {
             pairSounds[pairValue].play();
          }
