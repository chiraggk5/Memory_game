...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Duplicate the array to have pairs and then shuffle
    ...
    cardValues.forEach((value, index) => {
       ...
       cardFront.textContent = value;  // For now, we display the number
    ...
    // Check whether two flipped cards match
    function checkForMatch(){
       ...
       if(isMatch){
          ...
          // Clear the flipped cards array and unlock the board
          flippedCards = [];
          lockBoard = false;
          checkGameOver();
       } else {
    ...
    // Check if all cards have been matched and declare the winner
